...
describe Dea::Instance do
  ...
  describe "attributes from stat collector" do
    it "returns the used_memory_in_bytes stat in the attributes hash" do
      instance.stat_collector.stub(:used_memory_in_bytes).and_return(28 * 1024)
      instance.attributes.should include("used_memory_in_bytes" => 28)
    end

    it "returns the used_disk_in_bytes stat in the attributes hash" do
      instance.stat_collector.stub(:used_disk_in_bytes).and_return(40)
      instance.attributes.should include("used_disk_in_bytes" => 40)
    end

    it "returns the computed_pcpu stat in the attributes hash" do
      instance.stat_collector.stub(:computed_pcpu).and_return(0.123)
      instance.attributes.should include("computed_pcpu" => 0.123)
    end
  end
